...
model = joblib.load(os.path.join(MODEL_DIR, 'atm_weekly_usd_cash_forecast_model.pkl'))
model_features = model.get_booster().feature_names
joblib.dump(model.get_booster().feature_names, 'atm_weekly_usd_model_features.pkl')
...
def preprocess_input(df):
    ...
    try:
        ...
        # Remove rows where TRN_AMOUNT is exactly 0
...
def predict_future():
    ...
    try:
        ...
        atm_list = atm_list = usd_atms  # predefined ATM list
        ...
        # Find the next Saturday after the last date in the data
